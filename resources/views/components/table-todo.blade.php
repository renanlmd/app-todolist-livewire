        ...
        <div class="grid grid-cols-10" >
            <div class="col-span-1 h-14">
                <div class="flex items-center mt-2 ml-1">
                    ...
                    <div class="bg-white border-2 rounded-full w-10 h-10 flex flex-shrink-0 justify-center items-center mr-2  @if($toggleAll and !empty($todo->items())) border-blue-600 @else border-blue-400 @endif">
                        <svg class="fill-current @if($toggleAll and empty($todo->items())) hidden @endif w-6 h-6 pointer-events-none" version="1.1" viewBox="0 0 17 12" xmlns="http://www.w3.org/2000/svg">
                        <g fill="none" fill-rule="evenodd">
                            <g transform="translate(-9 -11)" fill="@if($toggleAll and !empty($todo->items())) #1F73F1 @endif" >
                ...
                <div class="col-span-1 h-14">
                    <div class="p-3 flex items-center">
                        <svg fill="none" viewBox="0 0 24 24" stroke="currentColor"
                            ...
                            wire:click="deleteTask({{ $key }}, {{ $todo->count() }} )">
